...
| Concepts | 256 | [Concept List](./concept-list.md) | Concepts from learning graph |
| Glossary Terms | 266 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 9 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 0 | - | Questions across all chapters |
| Diagrams | 121 | - | Level 4 headers starting with '#### Diagram:' |
| Equations | 0 | - | LaTeX expressions (inline and display) |
| MicroSims | 122 | [Simulations](../sims/index.md) | Interactive MicroSims |
| Total Words | 418,813 | - | Words in all markdown files |
| Links | 1498 | - | Hyperlinks in markdown format |
| Equivalent Pages | 1766 | - | Estimated pages (250 words/page + visuals) |
