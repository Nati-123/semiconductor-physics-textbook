---
title: P-N Junction Under Bias Interactive Walkthrough
description: An eight-step capstone MicroSim reviewing the entire Chapter 15 storyline, from forward and reverse bias to the complete junction I-V characteristic
image: /sims/pn-junction-under-bias-interactive-walkthrough/pn-junction-under-bias-interactive-walkthrough.png
quality_score: 85
---
...
This capstone MicroSim is an eight-step guided review of Chapter 15's complete storyline: forward and reverse bias, minority carrier injection, short-base and long-base diode profiles, saturation current, the ideal diode equation, avalanche breakdown, Zener breakdown, and the complete junction I-V characteristic. Navigate with Prev/Next buttons or the step dots.
</p>
...
<ul style="list-style: none; padding-left: 0; margin: 0;">
<li style="margin-bottom: 0.5rem; line-height: 1.75; color: #333; padding-left: 1.4rem; text-indent: -1.4rem;"><span style="color: #2E7D32; font-weight: 700; margin-right: 0.4rem;">&#10003;</span> Recall and summarize the full chain of concepts connecting applied bias to the complete junction I-V characteristic</li>
