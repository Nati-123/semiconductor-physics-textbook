---
title: Minority Carrier Injection Profile Explorer
description: A MicroSim comparing the long-base exponential and short-base linear excess minority carrier profiles injected at a p-n junction depletion edge under forward bias
image: /sims/minority-carrier-injection-profile-explorer/minority-carrier-injection-profile-explorer.png
quality_score: 85
---
...
<p style="color: #2E7D32; font-weight: 700; margin-top: 0; margin-bottom: 6px;">Bloom Level: Apply / Analyze (L3-L4) &nbsp;|&nbsp; Bloom Verb: Compare, Interpret</p>
<ul style="list-style: none; padding-left: 0; margin: 0;">
<li style="margin-bottom: 0.5rem; line-height: 1.75; color: #333; padding-left: 1.4rem; text-indent: -1.4rem;"><span style="color: #2E7D32; font-weight: 700; margin-right: 0.4rem;">&#10003;</span> Distinguish the short-base and long-base diode approximations from their carrier profile shapes</li>
<li style="margin-bottom: 0; line-height: 1.75; color: #333; padding-left: 1.4rem; text-indent: -1.4rem;"><span style="color: #2E7D32; font-weight: 700; margin-right: 0.4rem;">&#10003;</span> Interpret the profile's slope at the injection edge as the quantity that sets saturation current</li>
</ul>
</div>
