...
def csv_to_json(csv_path: str, json_path: str, color_config: dict = None, metadata: dict = None):
    ...
    taxonomy_names = {
        ...
        # Semiconductor Physics taxonomy
        'CRYS': 'Crystal Structure & Bonding',
        'QMBT': 'Quantum Mechanics & Band Theory',
        'MATL': 'Semiconductor Materials & Doping',
        'STAT': 'Carrier Statistics',
        'TRAN': 'Carrier Transport',
        'NEQ': 'Non-Equilibrium Carriers',
        'PNJ': 'P-N Junction',
        'MSJ': 'Metal-Semiconductor Junctions',
        'MOS': 'MOS Capacitor & Surfaces',
        'OPT': 'Optical & Thermal Properties',
        'DEV': 'Devices & Applications',
        # Standard/default text codes
        'FOUND': 'Physics & Math Foundations',
        'DEF': 'Definitions',
        'CORE': 'Core Concepts',
        'ADV': 'Advanced',
        'APPL': 'Applied',
