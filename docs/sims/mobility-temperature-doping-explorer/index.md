...
<h1 style="color: #5A3EED !important; border-bottom: 3px solid #5A3EED; padding-bottom: 0.4rem; font-weight: 800;">Mobility vs. Temperature and Doping (Matthiessen's Rule) Explorer</h1>
...
This MicroSim plots three mobility curves against temperature: lattice-limited mobility (\(\mu_L\propto T^{-3/2}\)), impurity-limited mobility (\(\mu_I\propto T^{3/2}/N\)), and their Matthiessen's-rule combination, \(1/\mu_{total}=1/\mu_L+1/\mu_I\). Carrier type and doping concentration sliders let students see how each scattering mechanism dominates in different regimes.
</p>
...
<p style="color: #2E7D32; font-weight: 700; margin-top: 0; margin-bottom: 6px;">Bloom Level: Analyze (L4) &nbsp;|&nbsp; Bloom Verb: Compare, Analyze</p>
<ul style="list-style: none; padding-left: 0; margin: 0;">
<li style="margin-bottom: 0.5rem; line-height: 1.75; color: #333; padding-left: 1.4rem; text-indent: -1.4rem;"><span style="color: #2E7D32; font-weight: 700; margin-right: 0.4rem;">&#10003;</span> Apply Matthiessen's rule to combine independent scattering mechanisms</li>
<li style="margin-bottom: 0; line-height: 1.75; color: #333; padding-left: 1.4rem; text-indent: -1.4rem;"><span style="color: #2E7D32; font-weight: 700; margin-right: 0.4rem;">&#10003;</span> Analyze which scattering mechanism dominates at a given temperature and doping level</li>
</ul>
</div>
...
<ul style="list-style: none; padding-left: 0; margin: 0;">
<li style="margin-bottom: 0.6rem; line-height: 1.75; color: #333;"><span style="color: #5A3EED; font-weight: 700; margin-right: 0.4rem;">&#9679;</span> <a href="https://en.wikipedia.org/wiki/Matthiessen%27s_rule" style="color: #5A3EED; font-weight: 600;">Matthiessen's Rule</a> — Wikipedia</li>
