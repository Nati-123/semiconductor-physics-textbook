---
title: Photon Energy Across the Electromagnetic Spectrum
description: Log-log chart comparing photon energy to wavelength across the electromagnetic spectrum, with silicon's band gap marked
image: /sims/photon-energy-spectrum-chart/photon-energy-spectrum-chart.png
quality_score: 85
---

<h1 style="color: #5A3EED !important; border-bottom: 3px solid #5A3EED; padding-bottom: 0.4rem; font-weight: 800;">Photon Energy Across the Electromagnetic Spectrum</h1>
...
<li style="margin-bottom: 0.6rem; line-height: 1.75; color: #333;"><strong style="color: #5A3EED;">Hover over the curve</strong> anywhere to read the exact photon energy and wavelength</li>
<li style="margin-bottom: 0.6rem; line-height: 1.75; color: #333;"><strong style="color: #5A3EED;">Find the shaded visible band</strong> and note how narrow it is compared to the full spectrum</li>
<li style="margin-bottom: 0; line-height: 1.75; color: #333;"><strong style="color: #5A3EED;">Locate the red dot</strong> where the silicon band-gap line crosses the curve, just past visible light in the near-infrared</li>
</ol>
...
<p style="color: #2E7D32; font-weight: 700; margin-top: 0; margin-bottom: 6px;">Bloom Level: Analyze (L4) &nbsp;|&nbsp; Bloom Verb: Compare</p>
<p style="color: #333; line-height: 1.75; margin-bottom: 0.6rem;">After using this MicroSim, students will be able to:</p>
<ul style="list-style: none; padding-left: 0; margin: 0;">
<li style="margin-bottom: 0.5rem; line-height: 1.75; color: #333; padding-left: 1.4rem; text-indent: -1.4rem;"><span style="color: #2E7D32; font-weight: 700; margin-right: 0.4rem;">&#10003;</span> Compare photon energies across the electromagnetic spectrum</li>
<li style="margin-bottom: 0.5rem; line-height: 1.75; color: #333; padding-left: 1.4rem; text-indent: -1.4rem;"><span style="color: #2E7D32; font-weight: 700; margin-right: 0.4rem;">&#10003;</span> Locate where silicon's band gap falls relative to visible light</li>
<li style="margin-bottom: 0; line-height: 1.75; color: #333; padding-left: 1.4rem; text-indent: -1.4rem;"><span style="color: #2E7D32; font-weight: 700; margin-right: 0.4rem;">&#10003;</span> Explain why a semiconductor absorbs some wavelengths of light but not others</li>
</ul>
</div>
...
<li style="margin-bottom: 0.5rem; line-height: 1.75; color: #333;">Hover over the gamma-ray and radio-wave ends of the curve and compare the energy values</li>
<li style="margin-bottom: 0.5rem; line-height: 1.75; color: #333;">Find the visible-light band and read off the energy range of visible photons</li>
<li style="margin-bottom: 0; line-height: 1.75; color: #333;">Locate the silicon band-gap marker and discuss why light just past red (near-infrared) can still be absorbed</li>
</ol>

<h3 style="color: #5A3EED; font-weight: 700; margin-top: 1.5rem; margin-bottom: 0.6rem;">After the Simulation (5 minutes)</h3>

<ul style="list-style: none; padding-left: 0.8rem; margin: 0.5rem 0 1rem 0;">
<li style="margin-bottom: 0.5rem; line-height: 1.75; color: #333;"><span style="color: #5A3EED; font-weight: 700; margin-right: 0.5rem;">&#9679;</span> Connect back to Worked Example 11 in the chapter</li>
<li style="margin-bottom: 0; line-height: 1.75; color: #333;"><span style="color: #5A3EED; font-weight: 700; margin-right: 0.5rem;">&#9679;</span> Preview optical absorption and solar cells in Chapter 17</li>
</ul>
...
<ul style="list-style: none; padding-left: 0; margin: 0;">
<li style="margin-bottom: 0.6rem; line-height: 1.75; color: #333;"><span style="color: #5A3EED; font-weight: 700; margin-right: 0.4rem;">&#9679;</span> <a href="https://en.wikipedia.org/wiki/Photon_energy" style="color: #5A3EED; font-weight: 600;">Photon Energy</a> — Wikipedia</li>
<li style="margin-bottom: 0.6rem; line-height: 1.75; color: #333;"><span style="color: #5A3EED; font-weight: 700; margin-right: 0.4rem;">&#9679;</span> <a href="https://en.wikipedia.org/wiki/Electromagnetic_spectrum" style="color: #5A3EED; font-weight: 600;">Electromagnetic Spectrum</a> — Wikipedia</li>
<li style="margin-bottom: 0; line-height: 1.75; color: #333;"><span style="color: #5A3EED; font-weight: 700; margin-right: 0.4rem;">&#9679;</span> <a href="../../chapters/01-physics-math-foundations/index.md#photon-energy" style="color: #5A3EED; font-weight: 600;">Chapter 1: Photon Energy</a> — this textbook</li>
</ul>
</div>
