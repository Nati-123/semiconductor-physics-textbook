---
title: Junction Capacitance Explorer
description: A MicroSim computing p-n junction capacitance from doping, area, and reverse bias, plotting capacitance versus reverse bias alongside a parallel-plate capacitor schematic
image: /sims/junction-capacitance-explorer/junction-capacitance-explorer.png
quality_score: 85
---
...
This MicroSim computes the <strong>junction capacitance</strong> \(C_j=\varepsilon A/W\) of a silicon p-n junction from doping concentrations, junction area, and reverse bias. A live chart plots \(C_j\) against reverse bias \(V_R\), and a parallel-plate capacitor schematic shows the depletion region visibly widening as reverse bias increases, directly illustrating why \(C_j\) falls.
</p>
...
<ul style="list-style: none; padding-left: 0; margin: 0;">
<li style="margin-bottom: 0.5rem; line-height: 1.75; color: #333; padding-left: 1.4rem; text-indent: -1.4rem;"><span style="color: #2E7D32; font-weight: 700; margin-right: 0.4rem;">&#10003;</span> Compute junction capacitance from depletion width and junction area</li>
<li style="margin-bottom: 0; line-height: 1.75; color: #333; padding-left: 1.4rem; text-indent: -1.4rem;"><span style="color: #2E7D32; font-weight: 700; margin-right: 0.4rem;">&#10003;</span> Explain qualitatively why reverse bias decreases junction capacitance</li>
</ul>
</div>
...
<ul style="list-style: none; padding-left: 0; margin: 0;">
<li style="margin-bottom: 0.6rem; line-height: 1.75; color: #333;"><span style="color: #5A3EED; font-weight: 700; margin-right: 0.4rem;">&#9679;</span> <a href="https://en.wikipedia.org/wiki/Varicap" style="color: #5A3EED; font-weight: 600;">Varicap (Varactor Diode)</a> — Wikipedia</li>
